...
namespace Transcoding.Transcoder
{
    ...
    public class Engine : EngineBase
    {
        ...
        public Engine(bool enableMultipleRunningProcesses) 
            : base(enableMultipleRunningProcesses)
        {
        }

        public Engine(string ffMpegPath, bool enableMultipleRunningProcesses) 
            : base(ffMpegPath, enableMultipleRunningProcesses)
        {
        }
